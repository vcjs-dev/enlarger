...
var f = (i, e, r) =>
    e in i
      ? b(i, e, { enumerable: !0, configurable: !0, writable: !0, value: r })
      : (i[e] = r),
  u = (i, e) => {
    for (var r in e || (e = {})) y.call(e, r) && f(i, r, e[r])
    if (d) for (var r of d(e)) C.call(e, r) && f(i, r, e[r])
    return i
  }
var s = (i, e, r) => (f(i, typeof e != 'symbol' ? e + '' : e, r), r)
