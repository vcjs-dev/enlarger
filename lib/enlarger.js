...
var m = (i, e, t) =>
    e in i
      ? y(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (i[e] = t),
  u = (i, e) => {
    for (var t in e || (e = {})) w.call(e, t) && m(i, t, e[t])
    if (d) for (var t of d(e)) b.call(e, t) && m(i, t, e[t])
    return i
  }
...
class I {
  ...
  previewListener(e) {
    const t = this.getContainer(),
      ...
      E = e.pageX - t.offsetLeft,
      v = e.pageY - t.offsetTop,
      p = t.offsetWidth - a.offsetWidth,
      c = t.offsetHeight - a.offsetHeight
    let g = E - a.offsetWidth / 2,
      o = v - a.offsetHeight / 2
    g <= 0 && (g = 0),
      g >= p && (g = p),
      o < 0 && (o = 0),
      o >= c && (o = c),
