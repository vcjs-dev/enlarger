...
var m = (i, e, t) => e in i ? y(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : i[e] = t, u = (i, e) => {
  for (var t in e || (e = {}))
    w.call(e, t) && m(i, t, e[t]);
  if (d)
    for (var t of d(e))
...
import { css as f, addClass as C } from "fourdom";
var h = /* @__PURE__ */ ((i) => (i.getContainerError = "container element is missing.", i.getMaskElError = "magnifier element is missing.", i.getEnlargerMainElError = "enlarger main element is missing.", i.getMagnifyContainerError = "magnify container element is missing.", i.getMagnifyImgElError = "magnify img element is missing.", i))(h || {}), n = /* @__PURE__ */ ((i) => (i.enlargerContainerClassName = "enlarger-container", i.enlargerImageWrapperClassName = "enlarger-image", i.enlargerImageClassName = "enlarger-image__inner", i.enlargerPreviewClassName = "enlarger-preview", i.enlargerPreviewImageClassName = "enlarger-preview__inner", i.enlargerMagnifierClassName = "enlarger-image__magnifier", i))(n || {});
class I {
  constructor(e) {
    s(this, "userOptions", {
      container: "",
  ...
  initOptions() {
    ...
    this.options = Object.assign(this.options, e), this.magnifyImgWidthScaleUpTimes = e != null && e.width ? this.imgNaturalWidth / e.width : this.options.magnifyImgScaleUpTimes, this.options.width = (e == null ? void 0 : e.width) || this.imgNaturalWidth / this.magnifyImgWidthScaleUpTimes, this.magnifyImgHeightScaleUpTimes = e != null && e.height ? this.imgNaturalHeight / e.height : this.magnifyImgWidthScaleUpTimes, this.options.height = (e == null ? void 0 : e.height) || this.imgNaturalHeight / this.magnifyImgHeightScaleUpTimes, this.magnifierWidth = this.options.width * this.options.magnifierSizeRatio, this.magnifierHeight = this.options.width * this.options.magnifierSizeRatio;
  }
  initCSSVars() {
    ...
    f(e, {
      ...
      "--enlarger-magnify-width": `${this.magnifierWidth * this.magnifyImgWidthScaleUpTimes}px`,
      "--enlarger-magnify-height": `${this.magnifierHeight * this.magnifyImgHeightScaleUpTimes}px`,
  ...
  previewListener(e) {
    const t = this.getContainer(), r = this.getEnlargerImageWrapperEl(), a = this.getMagnifierEl(), l = this.getPreviewImgEl(), E = e.pageX - t.offsetLeft, v = e.pageY - t.offsetTop, p = t.offsetWidth - a.offsetWidth, c = t.offsetHeight - a.offsetHeight;
    let g = E - a.offsetWidth / 2, o = v - a.offsetHeight / 2;
    g <= 0 && (g = 0), g >= p && (g = p), o < 0 && (o = 0), o >= c && (o = c), a.style.left = g + "px", a.style.top = o + "px", l.style.left = -g / r.offsetWidth * l.offsetWidth + "px", l.style.top = -o / r.offsetHeight * l.offsetHeight + "px";
  }
  registorListeners() {
  ...
  render() {
    ...
    C(e, n.enlargerContainerClassName);
    const t = `
